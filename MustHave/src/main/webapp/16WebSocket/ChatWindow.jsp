...
<title>웹소켓 채팅</title>
<script>
var wevSocket = new WebSocket("<%= application.getInitParameter("CHAT_ADDR")%>/ChatingServer");
...
webSocket.onopen = function(event){
	chatWindow.innerHTML +="웹소켓 서버에 연결되었습니다. <bt/>";
};

//웹소켓 서버에 닫혔을 때 실행
webSocket.onclose = function(event){
	chatWindow.innerHTML +="웹소켓 서버가 종료되었습니다. <bt/>";
};
...
#closeBtb{margin-bottom:3px; position:relative; top:2px; left:-2px}
